...
export default function EditDepartment() {
  ...
  const seedDefaultSections = async () => {
    const defaults = [
      { title: 'ABOUT THE DEPARTMENT', category: 'home', content: '<h2>About Us</h2>' },
      { title: 'VISION', category: 'home', content: '<p>Vision statement...</p>' },
      { title: 'MISSION', category: 'home', content: '<p>Mission statement...</p>' },
      { title: 'Programmes List', category: 'programmes', content: '<table>...</table>' },
      { title: 'Faculty Profiles', category: 'faculty', content: '<div>...</div>' }
    ];
